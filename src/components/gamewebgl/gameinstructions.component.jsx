...
const introText =" Live out your inner Han Solo. \nBlast your way through as many asteroids as you can, be sure to catch any power ups that hurdle your way. !Warning! Watch out for *{insert name here}*, contact will damage firing mechanisms temporarily."; 
...
const GameInstructions =()=>{
    ...
    return(
        <div>
                ...
                <TextContainer fontSize='20px' lineHeight='1.5' >
                   How long can you survive the Asteroid field?
                </TextContainer>
                <TextContainer fontSize='18px' lineHeight='1.2' textAlign='left' >
