...
const About =() => {
    return (
        <div className='aboutcontainer tc ph4'>
            <div className='title ttu f3 f2-m f1-l fw2 white-90 mv3'>About Me Section</div>
            <div className='f5 f4-m f3-l fw2 white-50 mt0 lh-copy'>
